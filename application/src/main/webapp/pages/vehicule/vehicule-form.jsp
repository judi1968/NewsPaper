<%@page import="model.table.Vehicule" %>
<%
                            ...
                            <div class="card-body">
                                ...
                                <% if(vehicule == null) { %>
                                    <form action="${pageContext.request.contextPath}/vehicule" method="post">
                                        <div class="row">
                                            <!-- Reference du vehicule -->
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Reference du vehicule</label>
                                                <input 
                                                    type="text"
                                                    class="form-control"
                                                    name="vehicule.reference"
                                                    placeholder="Ex: 2999TU"
                                                    required
                                                >
                                            </div>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select class="form-control" name="vehicule.typeCarburant" required>
                                ...
                                <% } else { %>
                                    <form action="${pageContext.request.contextPath}/vehicule" method="post">
                                        <input type="hidden" name="vehicule.id" value="<%= vehicule.getId() %>">
                                        <div class="row">
                                            <!-- Reference du vehicule -->
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Reference du vehicule</label>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select class="form-control" name="vehicule.typeCarburant" required>
                                                    <option value="">Selectionnez un type</option>
                                                    <% if(vehicule.getTypeCarburant().compareToIgnoreCase("El") == 0){ %>
                                                        <option value="El" selected >Electrique (El)</option>
                                                    <% } else { %>
                                                        <option value="El">Electrique (El)</option>
                                                    <% } %>

                                                    <% if(vehicule.getTypeCarburant().compareToIgnoreCase("D") == 0){ %>
                                                        <option value="D" selected>Diesel (D)</option>
                                                    <% } else { %>
                                                        <option value="D">Diesel (D)</option>
                                                    <% } %>

                                                    <% if(vehicule.getTypeCarburant().compareToIgnoreCase("H") == 0){ %>
                                                        <option value="H" selected >Hybride (H)</option>
                                                    <% } else { %>
                                                        <option value="H">Hybride (H)</option>
                                                    <% } %>

                                                    <% if(vehicule.getTypeCarburant().compareToIgnoreCase("E") == 0){ %>
                                                        <option value="E" selected >Essence (E)</option>
                                                    <% } else { %>
                                                        <option value="E">Essence (E)</option>
                                                    <% } %>
                                                </select>
